...
| A  | æ | as sounded in /gnat/ is represented by a small circle    | X |
| O  | ɑː | as sounded in /cod/ is represented by a large circle  | X |
| OO | ʊ | as sounded in /foot/ is represented by a radiated circle | X |
| UH | ʌ | as sounded in /nut/ is represented by a dot              | X |
...
*Ex*: /ag/ X, /ar/ X, /ob/ X, /om/ X, /at/ X, /od/ X, /as/ X, /us/ X, /ath/ X, /oth/ X, /ang/ X, /ur/ X, /ut/ X, /up/ X, /ug/ X, etc.

**** In the body of words
Trace the vowel _outside the angle_ formed by two consonants, viz /f-d/ X with a vowel /f-a-d/ X.
