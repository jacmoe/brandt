...
| X | Be X | Pe X | drawn straight downwards            |
| X | De X | Te X | drawn from left to right           |
| X | Ge X | Ke X | drawn obliquely from right to left |
| X | Ve X | Fe X | drawn obliquely from left to right |
| X | Re X | Le X | drawn upwards from left to right   |
...
The consonant Re has two distinct shades of sound, one hard or trill-sound as in /broil/, /zeal/, /umbrella/; the other is a soft and frequently barely audible sound as in /door/, /fear/, /heart/, this latter may be distinguished from the former by a dash written in the middle of the sign: X.
